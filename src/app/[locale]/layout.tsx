...
export default async function RootLayout({
  ...
  return (
    <html lang={locale} className="dark" suppressHydrationWarning>
      <body
        className="min-h-screen bg-slate-950 font-sans antialiased text-white"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Senior Frontend Developer specializing in React, Next.js, and TypeScript architecture.",
